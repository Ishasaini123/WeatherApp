...
1. Clone the repository: `https://github.com/Ishasaini123/WeatherApp`
...
## ✨Credits
`WeatherApp` is developed and maintained by `Isha`. Weather data is retrieved from the [OpenWeatherMap API](https://openweathermap.org/).

## 📧Contacts
For any inquiries or feedback, please contact [Here](mailto:ishasaini0404@gmail.com).
